...
{
    public class MiniknogLauncher : GlowItem
    {
    ...
    public class MiniknogLauncherProj : RangedHeldProjectile
    {
        ...
        public T UpgradeValue<T>(T normal, T extra, T ultra, T defaultValue = default)
        {
            ...
            if (type == ModContent.ItemType<MiniknogLauncherEX>())
            {
                return extra;
            }

            if (type == ModContent.ItemType<MiniknogLauncherLT>())
            {
                return ultra;
            }
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), ShootCenter, vel, ModContent.ProjectileType<MiniknogRocket>(), Projectile.damage, 5f, Projectile.owner, ai0);
    ...
    public class MiniknogRocket : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(projectile.GetSource_FromThis(), projectile.Center, Main.rand.NextVector2Unit() * 16, projectile.type, projectile.damage / 2, 5f, projectile.owner, 4);
        }
