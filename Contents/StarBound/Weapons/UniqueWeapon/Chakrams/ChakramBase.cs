...
{
    public abstract class ChakramBaseItem : GlowItem
    {
        ...
        {
            Projectile.NewProjectile(source, position, velocity, type, damage, knockback, player.whoAmI, player.altFunctionUse == 2 ? 1 : 0, Extra ? 1 : 0);
            return false;
        }
    }
    public abstract class ChakramBaseProjectile : ModProjectile
    {
        ...
        bool hit => projectile.timeLeft <= 150;
