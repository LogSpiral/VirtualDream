...
{
    public abstract class WhipBase_Item : ModItem
    {
    ...
    public abstract class WhipBase_Projectile : ModProjectile
    {
        ...
        {
            //source = _source;
            if (_source is EntitySource_ItemUse source_ItemUse) 
            {
                sourceItemType = source_ItemUse.Item.type;
            }
